        ...
        <DetailHeader>
          ...
          <DetailHeaderBox>
            ...
            <PickArea>
              <PickBtn
                onClick={() =>
                  copyLink(`http://localhost:3000${location.pathname}`)
                }
              >
                <FiShare />
                공유하기
        ...
        <AccPictureBox>
          <MainPic>
            <ImgTagBox>
              <ImgTag
                src={
                  getAccommodationFocus?.accommoInfo?.AccommodationsPictures[0]
                    ?.thumbnail
                }
              />
            </ImgTagBox>
          ...
          <OtherPic>
            <OtherPicBox>
              <ImgTagBox>
                <ImgTag
                  src={
                    getAccommodationFocus?.accommoInfo
                      ?.AccommodationsPictures[0]?.image1
                  }
                />
              </ImgTagBox>
              <ImgTagBox>
                <ImgTag
                  src={
                    getAccommodationFocus?.accommoInfo
                      ?.AccommodationsPictures[0]?.image2
                  }
                />
              </ImgTagBox>
            </OtherPicBox>
            <OtherPicBox>
              <ImgTagBox>
                <ImgTag
                  src={
                    getAccommodationFocus?.accommoInfo
                      ?.AccommodationsPictures[0]?.image3
                  }
                />
              </ImgTagBox>
              <ImgTagBox>
                <ImgTag
                  src={
                    getAccommodationFocus?.accommoInfo
                      ?.AccommodationsPictures[0]?.image4
                  }
                />
              </ImgTagBox>
            </OtherPicBox>
          ...
          <DetailBox>
            <DatailBoxHeader>
              <DatailBoxHeader2>
                ...
                <Font16>
                  최대 인원 {getAccommodationFocus?.accommoInfo?.maxPerson}명 ·
                  방 {getAccommodationFocus?.accommoInfo?.room} · 침대{" "}
                  {getAccommodationFocus?.accommoInfo?.bed}개 · 욕실{" "}
                  {getAccommodationFocus?.accommoInfo?.bathroom}개
                </Font16>
              </DatailBoxHeader2>
              <DatailBoxHeader2>
                <ProfileImg
            ...
            <Padding24 gap="5px">
              <CiParking1 size={24} />
              <FlexCol>
                <Font16 fontWeight="600">무료 주차 혜택을 누리세요</Font16>
                <Font14>
            ...
            <Liner />
            <Padding24 gap="20px" flexDir="column">
              ...
              <Font16 fontWeight="600" textDecoration="underline">
                더 알아보기
              </Font16>
            </Padding24>
            <Liner />
            <Padding24 gap="20px" flexDir="column">
              <Font16>{getAccommodationFocus?.accommoInfo?.description}</Font16>
              <Font16 fontWeight="600" textDecoration="underline">
                더 보기
              </Font16>
            </Padding24>
            <Liner />
            <Padding48 flexDir="column" gap="24px">
              <Font22>숙소 편의시설</Font22>
              <FlexCol gap="16px" maxHeight="160px">
                {splitFacilities?.map(
                  (item) =>
                    item.includes("drier") && (
                      <FlexRow gap="10px">
                        <FacImg src={initFacilities?.drier} alt="drier" />
                        <Font16>드라이어</Font16>
                      </FlexRow>
                    )
                )}
                {splitFacilities?.map(
                  (item) =>
                    item.includes("shampoo") && (
                      <FlexRow gap="10px">
                        <FacImg src={initFacilities?.shampoo} alt="shampoo" />
                        <Font16>샴푸</Font16>
                      </FlexRow>
                    )
                )}
                {splitFacilities?.map(
                  (item) =>
                    item.includes("bath") && (
                      <FlexRow gap="10px">
                        <FacImg src={initFacilities?.bath} alt="bath" />
                        <Font16>욕조</Font16>
                      </FlexRow>
                    )
                )}
                ...
                {splitFacilities?.map(
                  (item) =>
                    item.includes("heating") && (
                      <FlexRow gap="10px">
                        <FacImg src={initFacilities?.heating} alt="heating" />
                        <Font16>난방</Font16>
                      </FlexRow>
                    )
                )}
                {splitFacilities?.map(
                  (item) =>
                    item.includes("wifi") && (
                      <FlexRow gap="10px">
                        <FacImg src={initFacilities?.wifi} alt="wifi" />
                ...
                {splitFacilities?.map(
                  (item) =>
                    item.includes("parking") && (
                      <FlexRow gap="10px">
                        <FacImg src={initFacilities?.parking} alt="parking" />
                        <Font16>주차</Font16>
                      </FlexRow>
                    )
                )}
            ...
            <Liner />
            <Padding48 gap="5px" flexDir="column">
              <Font22>속초시에서 5박</Font22>
              <Font14>2022년 11월 1일 - 2022년 11월 6일</Font14>
              ...
              <StickyBox>
                <FlexCol gap="5px">
                  <FlexRowLeftCenter>
                    <Font22>
                      ₩
                      {priceToString(getAccommodationFocus?.accommoInfo?.price)}{" "}
                    </Font22>
                    <Font16>/박</Font16>
                  </FlexRowLeftCenter>
                  <FlexRow>
                    ...
                    <Font14Underline>후기 {"46"}개</Font14Underline>
                  </FlexRow>
                </FlexCol>
                <BorderBox>
                  <FlexCol>
                    <FlexRow
                      ...
                      borderBottom="none"
                    >
                      <FlexCol gap="5px" padding="10px">
                        <Text fontSize="10px" fontWeight="600">
                          체크인
                        </Text>
                        <Text fontSize="14px">2022.11.05</Text>
                      </FlexCol>
                      <FlexCol
                        gap="5px"
                      ...
                      >
                        ...
                        <Text fontSize="14px">2022.11.09</Text>
                      </FlexCol>
                    </FlexRow>
                    <FlexRow
                      border="1px solid #B0B0B0"
                    ...
                    >
                      <FlexCol gap="5px" padding="10px">
                        ...
                        <Text fontSize="14px">게스트 1명</Text>
                      </FlexCol>
                ...
                <FlexCol gap="10px">
                  <FlexRow justifyContent="space-between">
                    ...
                    <Text fontSize="14px">₩{priceToString(initTotal)}</Text>
                  </FlexRow>
                  <FlexRow justifyContent="space-between">
                    <Text fontSize="14px" textDecoration="underline">
                      서비스 수수료
                    </Text>
                    <Text fontSize="14px">₩{priceToString(vatTotal)}</Text>
                  </FlexRow>
                </FlexCol>
                <Liner />
                <FlexRow justifyContent="space-between">
