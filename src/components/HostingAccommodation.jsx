		...
		<>
			...
			<ContentCtn>
				<FlexCol gap='10px'>
					...
					<Text fontSize='32px' fontWeight='800'>호스팅</Text>
				</FlexCol>

				<FlexCol gap='20px'>
					<FlexCol gap='10px'>
						<Text fontSize='16px' fontWeight='600'>숙소 이름</Text>
						<InputArea
							type="text"
							name="accName"
							ref={accNameRef}
					...
					<Liner />
					<FlexCol gap='10px'>
						<Text fontSize='16px' fontWeight='600'>숙소 주소</Text>
						<InputArea
							type="text"
							name="accAddr"
							ref={accAddrRef}
					...
					<Liner />
					<FlexCol gap='10px'>
						<Text fontSize='16px' fontWeight='600'>숙소 가격</Text>
						<InputArea
							type="text"
							name="price"
							ref={priceRef}
					...
					<Liner />
					<FlexCol gap='10px'>
						<Text fontSize='16px' fontWeight='600'>숙소 설명</Text>
						<InputTextArea
							type="text"
							name="description"
							ref={descriptionRef}
					...
					<Liner />
					<FlexCol gap='10px'>
						<Text fontSize='16px' fontWeight='600'>최대 인원 수</Text>
						<InputArea
							type="text"
							name="maxPerson"
							ref={maxPersonRef}
					...
					<Liner />
					<FlexCol gap='10px'>
						<Text fontSize='16px' fontWeight='600'>침대</Text>
						<InputArea
							type="text"
							name="bed"
							ref={bedRef}
					...
					<Liner />
					<FlexCol gap='10px'>
						<Text fontSize='16px' fontWeight='600'>방</Text>
						<InputArea
							type="text"
							name="room"
							ref={roomRef}
					...
					<Liner />
					<FlexCol gap='10px'>
						<Text fontSize='16px' fontWeight='600'>사진</Text>
